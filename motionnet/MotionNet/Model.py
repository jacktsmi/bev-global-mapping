...
class STPN(nn.Module):
    def __init__(self, height_feat_size=13, T=5):
        ...
        if T >= 5:
            self.conv3d_2 = Conv3D(256, 256, kernel_size=(5, 1, 1), stride=1, padding=(0, 0, 0))
        if T >= 7:
            self.conv3d_3 = Conv3D(512, 512, kernel_size=(7, 1, 1), stride=1, padding=(0, 0, 0))
        if T >= 9:
            self.conv3d_4 = Conv3D(1024, 1024, kernel_size=(7, 1, 1), stride=1, padding=(0, 0, 0))
    ...
    def forward(self, x):
        ...
        if batch > 1:
            ...
            #print("x_TP: ",x.shape)
            #print("x_1_TP: ",x_1.shape)
            #print("x_2_TP: ",x_2.shape)
            #print("x_3_TP: ",x_3.shape)
            #print("x_4_TP: ",x_4.shape)
            ...
            # -- STC block 2
            x_2 = F.relu(self.conv2_1(x_1))
            x_2 = F.relu(self.conv2_2(x_2))
            ...
            # -- STC block 3
            x_3 = F.relu(self.conv3_1(x_2))
            x_3 = F.relu(self.conv3_2(x_3))
            ...
            # -- STC block 4
            x_4 = F.relu(self.conv4_1(x_3))
            x_4 = F.relu(self.conv4_2(x_4))
            ...
            # -------------------------------- Decoder Path --------------------------------
            x_5 = F.relu(self.conv5_1(torch.cat((F.interpolate(x_4, scale_factor=(2, 2)), x_3), dim=1)))
            x_5 = F.relu(self.conv5_2(x_5))

            #print("x_5: ",x_5.shape)        

            x_6 = F.relu(self.conv6_1(torch.cat((F.interpolate(x_5, scale_factor=(2, 2)), x_2), dim=1)))
            x_6 = F.relu(self.conv6_2(x_6))

            #print("x_6: ",x_6.shape)        

            x_7 = F.relu(self.conv7_1(torch.cat((F.interpolate(x_6, scale_factor=(2, 2)), x_1), dim=1)))
            x_7 = F.relu(self.conv7_2(x_7))

            #print("x_7: ",x_7.shape)        


            x_8 = F.relu(self.conv8_1(torch.cat((F.interpolate(x_7, scale_factor=(2, 2)), x), dim=1)))

            #print("x_8: ",x_8.shape)        

            res_x = F.relu(self.conv8_2(x_8))
